...
export const normal = () => (
  <>
    ...
    objectfit contain
    <Image size="200px" objectFit="contain" src="http://placekitten.com/200/300" />
    objectposition 0 0
    <Image size="200px" objectPosition="0% 0%" src="http://placekitten.com/200/300" />
    auto height
...
export const lazyLoadStressTest = () => (
  <>
    The dimensions must be specified for this to work. So either height+width, flex-basis etc.. or a
